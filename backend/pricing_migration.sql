...
-- ── Vận tải biển FCL ──
INSERT INTO pricing_rates (service_type, route, unit, price_from, currency, transit_time, note, is_active) VALUES
('sea_fcl', 'TP.HCM → Shanghai (Trung Quốc)', '20'' DC', 320, 'USD', '5–7 ngày', 'Giá cước thuần, chưa gồm phụ phí', 1),
('sea_fcl', 'TP.HCM → Shanghai (Trung Quốc)', '40'' HC', 520, 'USD', '5–7 ngày', 'Giá cước thuần, chưa gồm phụ phí', 1),
('sea_fcl', 'TP.HCM → Busan (Hàn Quốc)', '20'' DC', 380, 'USD', '5–6 ngày', 'Giá cước thuần, chưa gồm phụ phí', 1),
('sea_fcl', 'TP.HCM → Busan (Hàn Quốc)', '40'' HC', 620, 'USD', '5–6 ngày', 'Giá cước thuần, chưa gồm phụ phí', 1),
('sea_fcl', 'TP.HCM → Rotterdam (Hà Lan)', '20'' DC', 1200, 'USD', '28–32 ngày', 'Qua kênh đào Suez', 1),
('sea_fcl', 'TP.HCM → Rotterdam (Hà Lan)', '40'' HC', 2100, 'USD', '28–32 ngày', 'Qua kênh đào Suez', 1),
('sea_fcl', 'TP.HCM → Los Angeles (Mỹ)', '20'' DC', 1800, 'USD', '18–22 ngày', NULL, 1),
('sea_fcl', 'TP.HCM → Los Angeles (Mỹ)', '40'' HC', 3200, 'USD', '18–22 ngày', NULL, 1),
('sea_fcl', 'Hà Nội → Singapore', '20'' DC', 290, 'USD', '4–5 ngày', 'Từ cảng Hải Phòng', 1),
('sea_fcl', 'Hà Nội → Singapore', '40'' HC', 480, 'USD', '4–5 ngày', 'Từ cảng Hải Phòng', 1);

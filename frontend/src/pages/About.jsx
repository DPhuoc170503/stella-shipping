...
const t_ui = {
  vi: {
    ...
    story_h2: "Từng bước vững vàng trên hành trình kết nối",
    story_p1: "Stella Shipping được thành lập vào tháng 10/2023 với mong muốn mang đến những giải pháp logistics linh hoạt, hiệu quả và phù hợp với nhu cầu thực tế của từng khách hàng.",
    story_p2: "Là một doanh nghiệp trẻ, chúng tôi hiểu rằng sự tin tưởng không đến từ những lời giới thiệu lớn lao, mà được xây dựng từ sự tận tâm trong từng lô hàng, sự chủ động trong từng tình huống và trách nhiệm trong từng cam kết. Từ những ngày đầu hoạt động, Stella Shipping đã không ngừng học hỏi, hoàn thiện quy trình và mở rộng mạng lưới đối tác để từng bước nâng cao chất lượng dịch vụ. Mỗi booking được xử lý, mỗi hành trình hàng hóa được theo dõi và mỗi phản hồi từ khách hàng đều là một phần trong quá trình trưởng thành của chúng tôi. Stella Shipping vẫn đang trên hành trình phát triển và vững bước từng ngày. Với tinh thần trách nhiệm, sự linh hoạt và mong muốn đồng hành lâu dài cùng khách hàng, chúng tôi hướng đến việc trở thành một đối tác logistics đáng tin cậy, kết nối hàng hóa Việt Nam với các thị trường trên thế giới.",
    story_l1: "Đội ngũ trẻ, tận tâm và am hiểu nghiệp vụ logistics ",
    story_l2: "Linh hoạt trong việc tư vấn và xử lý từng lô hàng ",
    story_l3: "Không ngừng mở rộng mạng lưới hãng tàu, đại lý và đối tác quốc tế",
    story_l4: "Theo sát hành trình hàng hóa và chủ động cập nhật thông tin đến khách hàng",
